...
# Merging with Sample metadata to get specific and general tissue type
merged_data <-  merge(gene_expr,gtex_metadata[,c("SAMPID","SMTSD","SMTS","SUBJID")],by= "SAMPID")
...
# Adding midpoint values to matrix
